...
export default class Generator {
  ...
  append(dst, text, line) {
    ...
    //(2) append
    if (this.mute) this[append](entry, text, line);
    else this.simple(params => this[append](...params))(`Append content to ${entry}`, entry, text, line);
  }

  [append](dst, text, line) {
    new fs.File(dst).appendText(text, line);
  }
