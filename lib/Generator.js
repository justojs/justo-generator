...
export default class Generator {
  ...
  copy(src, name) {
    ...
    else this.simple(params => this[copy](...params))(`Copy ${dst}`, entry, dst);
  }
  ...
  remove(...entry) {
    ...
    else this.simple(params => this[remove](...params))(`Remove ${entry}`, entry);
  }
  ...
  mkdir(dir) {
    ...
    else this.simple(params => this[mkdir](...params))(`Create directory ${dir}`, dir);
  }
